  ...
  const fetchSurah = useCallback(async () => {
    try {
      ...
      const combinedAyahs = arabicResp.data.data.ayahs.map((ayah: AyahType, index: number) => ({
        ...
        englishAudio: `https://audio.recitequran.com/en/${ayah.number}`, // Example URL, replace with actual English audio API
        urduAudio: `https://audio.recitequran.com/ur/${ayah.number}`, // Example URL, replace with actual Urdu audio API
      }));
